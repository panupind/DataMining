...
```{r}
## Predict on Test Data using the CART model
testdata$predict.class=predict(tree_full,testdata,type="class")
testdata$predict.score=predict(tree_full,testdata)

testdata$predict.class

print(testdata$predict.class)
print(testdata$predict.score)
...
?rbind
df_fin =rbind(df_fin, df_results_train, df_results_test)
names(df_fin) = c('tree_full_train', 'tree_full_test', 'tree_train', 'tree_test', 'ptree_train', 'ptree_test')
round(df_fin,2)
```
