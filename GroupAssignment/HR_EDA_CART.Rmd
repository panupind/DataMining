...
Attr_Education <- ggplot(HR_Data, aes(x = HR_Data$Education , y = HR_Data$Attrition  , fill = HR_Data$Attrition))+
  geom_bar( position = "stack" , stat =  "identity" ) + xlab("Education") + ylab("Attrition")
...
#EnvirnmentSatisfaction

Attr_EnvironmentSatisfaction <- ggplot(HR_Data, aes(x = HR_Data$EnvironmentSatisfaction , y = HR_Data$Attrition  , fill = HR_Data$Attrition))+
  geom_bar( position = "stack" , stat =  "identity" ) + xlab("EnvironmentalSatisfaction") + ylab("Attrition")


plot(Attr_EnvironmentSatisfaction)


#JobInvolvement

Attr_JobInvolvement <- ggplot(HR_Data, aes(x = HR_Data$JobInvolvement , y = HR_Data$Attrition  , fill = HR_Data$Attrition))+
  geom_bar( position = "stack" , stat =  "identity" ) + xlab("JobInvolvement") + ylab("Attrition")
...
Attr_JobSatisfaction <- ggplot(HR_Data, aes(x = HR_Data$JobSatisfaction , y = HR_Data$Attrition  , fill = HR_Data$Attrition))+
  geom_bar( position = "stack" , stat =  "identity" ) + xlab("JobSatisfaction") + ylab("Attrition")
...
Attr_PerformanceRating <- ggplot(HR_Data, aes(x = HR_Data$PerformanceRating , y = HR_Data$Attrition  , fill = HR_Data$Attrition))+
  geom_bar( position = "stack" , stat =  "identity" ) + xlab("PerformanceRating") + ylab("Attrition")
...
Attr_RelationshipSatisfaction <- ggplot(HR_Data, aes(x = HR_Data$RelationshipSatisfaction , y = HR_Data$Attrition  , fill = HR_Data$Attrition))+
  geom_bar( position = "stack" , stat =  "identity" ) + xlab("RelationshipSatisfaction") + ylab("Attrition")
...
Attr_WorkLifeBalance <- ggplot(HR_Data, aes(x = HR_Data$WorkLifeBalance , y = HR_Data$Attrition  , fill = HR_Data$Attrition))+
  geom_bar( position = "stack" , stat =  "identity" ) + xlab("WorkLifeBalance") + ylab("Attrition")
...
ggarrange(Attr_Gender , Attr_BusinessTravel , Attr_Department , Attr_EducationField , Attr_Education , Attr_JobRole , Attr_MaritalStatus , Attr_OverTime , Attr_EnvironmentSatisfaction , Attr_JobInvolvement , Attr_JobSatisfaction , Attr_PerformanceRating , Attr_RelationshipSatisfaction, Attr_WorkLifeBalance 
  + rremove("x.text"),
